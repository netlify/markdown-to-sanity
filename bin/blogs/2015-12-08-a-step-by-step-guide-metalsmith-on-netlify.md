...
description: >-
  ...
  Netlify (incl. continuous deployment).
...
This it where the `.gitignore` file comes into play. Create a file in the root of the site named `.gitignore` and fill it in with the following:
