...
description: >-
  In this article, we reintroduce closures by building a tiny clone of React
  Hooks. This will serve two purposes - to demonstrate the effective use of
  closures in building our React Hooks clone itself, and also to implement a
  naive mental model of how Hooks work under the hood. Finally, we arrive at how
  Custom Hooks naturally arise.
authors:
  - swyx
date: '2019-03-11'
topics:
...
tags:
  ...
  - Closure
tweet: >-
  Practice using JavaScript Closures and Demystify React Hooks with a simple 26
  line clone of the API!
format: blog
---

> Author's Note: This article has been [turned into a talk](https://www.swyx.io/talks/react-hooks), with more context. Also, this article does not mention [the React scheduler](https://www.swyx.io/talks/react-not-reactive) or [how state is actually stored in React](https://medium.com/@dan_abramov/making-sense-of-react-hooks-fdbde8803889).
